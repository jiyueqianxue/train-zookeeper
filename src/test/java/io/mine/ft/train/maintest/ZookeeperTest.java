...
public class ZookeeperTest {
	...
	private Watcher watcher =  new Watcher() {
		...
		public void process(WatchedEvent event) {
			LOGGER.info("process connect zk : " + event.getType());
		}
	};
...
//		//监控事件
//		public void process(WatchedEvent event) {
//			LOGGER.info("process create zk : " + event.getType());
//		}
//	};
	...
	public void connect() throws IOException {
		zooKeeper  = new ZooKeeper("159.138.64.12:9070,159.138.64.12:9080,159.138.64.12:9090", SESSION_TIMEOUT, watcher);
	}
